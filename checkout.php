 ...
 *
	...
	* 1.0.0 - Support for payment polls, support for old deprecated method

	Changelog:

	* 2013-10-7 - 0.1.0 - Initial release. Support for basic checkouts.

	Interface API may change in between major versions.
